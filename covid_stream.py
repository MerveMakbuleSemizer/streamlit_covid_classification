...
input_df = pd.DataFrame({
    ...
    "USMER_2":[usmer],
    'SEX_M': [sex],
    "PATIENT_TYPE_1":[patient_type],
    "PNEUMONIA_1.0":[pneumonia],
    "PREGNANT_1.0":[pregnancy],
    "DIABETES_1.0":[diabetes],
    "COPD_1.0":[copd],
    "ASTHMA_1.0":[asthma],
    "INMSUPR_1.0":[inmsupr],
    "HIPERTENSION_1.0":[hipertension],
    "OTHER_DISEASE_1.0":[other_disease],
    "CARDIOVASCULAR_1.0":[cardiovascular],
    "OBESITY_1.0":[obesity],
    "RENAL_CHRONIC_1.0":[renal_chronic],
    "TOBACCO_1.0":[tobacco],
    "classification_P":[classification]
})
