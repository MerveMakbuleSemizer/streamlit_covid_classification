...
decision_tree_model = load('decision_tree_oversampling.pkl')
...
pred = decision_tree_model.predict(input_df.values)
pred_probability = np.round(decision_tree_model.predict_proba(input_df.values), 2)
