...
random_forest_model = load('random_forest_smote.pkl')
...
pred = random_forest_model.predict(input_df.values)
pred_probability = np.round(random_forest_model.predict_proba(input_df.values), 2)
